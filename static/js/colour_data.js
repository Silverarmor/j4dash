...
let JK_colours = {
    ...
    "CIVIL 300": "rgb(255, 110, 50)", //ff6e32 orange
    "ENVENG 300": "rgb(151, 212, 80)", //c2fa78 light green
    "STRCTENG 304": "rgb(243, 182, 31)", //yellow
    "ENGGEN 303": "rgb(100, 100, 120)", // bluey grey
...
let JP_colours = {
    ...
    "NS: Lecture": "#35827C", //lighter grey aka teal
...
let JT_colours = {
    ...
    "COMPSCI 215 LAB": "#C31D2B", // Darker red
    "PHYSICS 140 LAB": "#2A5ADF", // Darker blue
    "COMPSCI 215": "#E23C4A", //red
    "PHYSICS 140": "#7494EA", //blue
    "LAW 231": "#CFA5A0", //LAW 231A matches this Rosy brown
    "LAW 241": "#00E0AC", //LAW 241A matches this. Aquamarine
    "LAWGENRL 433": "#044B74", // matches this. Indigo
